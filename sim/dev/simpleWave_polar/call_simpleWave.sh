...
gfortran -O3 -o simpleWave.o simulations/simpleWave.f90 -I/usr/include/hdf5/serial -L/usr/lib/x86_64-linux-gnu/hdf5/serial -lhdf5_fortran -lhdf5
gfortran -O3 -o simpleWaveT.o simulations/aveDefect.f90
...
do
 ...
 #   cd ./mu-"$mu"
    ...
    ./simpleWave.o $params | tee -a meanE.dat
