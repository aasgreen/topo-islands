...
gfortran -O3 -o islandC_p.o simulations/islandC_p.f90 -I/usr/include/hdf5/serial -L/usr/lib/x86_64-linux-gnu/hdf5/serial -lhdf5_fortran -lhdf5
gfortran -O3 -o islandC_pT.o simulations/aveDefect.f90
...
do
 ...
 #   cd ./mu-"$mu"
    ...
    ./islandC_p.o $params | tee -a meanE.dat
