...
gfortran -O3 -o simpleWave_np.o simulations/simpleWave_np.f90 -I/usr/include/hdf5/serial -L/usr/lib/x86_64-linux-gnu/hdf5/serial -lhdf5_fortran -lhdf5
gfortran -O3 -o simpleWave_npT.o simulations/aveDefect.f90
...
do
 ...
 #   cd ./mu-"$mu"
    ...
    ./simpleWave_np.o $params | tee -a meanE.dat
