...
!the following code deals with the radius of an island. We have reused it for our linear region in the center 
x_pos = -50
x_delt = 5
...
contains
    ...
    function torque(i,j,theta,kappa,mu,fieldphi)
        ...
        torque = kappa*(sin(x(2)-x(1))+sin(x(2)-x(3))+sin(y(2)-y(1))+sin(y(2)-y(3)))+mu*sin( (theta-fieldphi) )**2
    end function torque
