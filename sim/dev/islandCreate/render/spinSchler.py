...
#    return [imSeq,dimSeq]
    ...
    return [imSeq, fN, dimSeq, dfN, anchor]
...
if __name__ == '__main__':
    ...
    imSeq, fN, dimSeq, dfN, anchor = read_files(args)
...
#    dimSeq = [np.loadtxt(f) for f in dfN[0]]
    ...
    ax2.imshow(schler(fMain),cmap='gray',origin='top')
    ...
    anim.save('b-{}monte-carlo-xy-texture.mp4'.format(beta))
